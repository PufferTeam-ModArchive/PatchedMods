...
public class BCreativeMachine extends BElementMachine {
    ...
    public PItem getItemBlock() {
        return new BITexted(
            EnumChatFormatting.LIGHT_PURPLE + "This is a configureable piston and rotator in one block.");
    }
            ...
            if (tile.active) {
                ...
                if (command != null) {
                    ...
                    if (command.mode == CMRedstoneCommand.MOVE_MODE) {
                        ...
                        PistonSystem system = new PistonSystem(
                            proxy,
                            facing,
                            command.getRotateSpeed(),
                            SystemType.ROTATE);
                        system.tryRotate();
                    }
                }
