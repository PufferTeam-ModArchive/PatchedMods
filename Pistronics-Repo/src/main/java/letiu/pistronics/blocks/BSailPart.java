        ...
        if (tile != null && tile instanceof TilePartblock) {
            ...
            if (tilePart != null && tilePart instanceof TileSail) {
                ...
                if (sailTile.face == 0 || sailTile.face == 1) {
                    if (meta == 2 || meta == 3)
                        box = AxisAlignedBB.getBoundingBox(0.0F, SAIL_A, 0.0F, 1.0F, SAIL_B, 0.75F);
                    else if (meta == 4 || meta == 5)
                        box = AxisAlignedBB.getBoundingBox(0.0F, SAIL_A, 0.0F, 0.75F, SAIL_B, 1.0F);
                } else if (sailTile.face == 2 || sailTile.face == 3) {
                    if (meta == 0 || meta == 1)
                        box = AxisAlignedBB.getBoundingBox(0.0F, 0.0F, SAIL_A, 1.0F, 0.75F, SAIL_B);
                    else if (meta == 4 || meta == 5)
                        box = AxisAlignedBB.getBoundingBox(0.0F, 0.0F, SAIL_A, 0.75F, 1.0F, SAIL_B);
                } else if (sailTile.face == 4 || sailTile.face == 5) {
                    if (meta == 0 || meta == 1)
                        box = AxisAlignedBB.getBoundingBox(SAIL_A, 0.0F, 0.0F, SAIL_B, 0.75F, 1.0F);
                    else if (meta == 2 || meta == 3)
                        box = AxisAlignedBB.getBoundingBox(SAIL_A, 0.0F, 0.0F, SAIL_B, 1.0F, 0.75F);
                }
                ...
                switch (meta) {
                    case 1:
                        box = box.getOffsetBoundingBox(0F, 0.25F, 0F);
                        break;
                    case 3:
                        box = box.getOffsetBoundingBox(0F, 0F, 0.25F);
                        break;
                    case 5:
                        box = box.getOffsetBoundingBox(0.25F, 0F, 0F);
                        break;
                }
