...
public class BExtensionPart extends BExtension implements IPart {
    ...
    public boolean shouldSideBeRendered(IBlockAccess world, int x, int y, int z, int side) {
        ...
        else facing = WorldUtil.getBlockFacing(
            world,
    ...
    public ArrayList<AxisAlignedBB> getBoxes(IBlockAccess world, int x, int y, int z, int meta) {
        ...
        switch (meta & 7) {
            case 0:
                ...
                boxes.add(AxisAlignedBB.getBoundingBox(0.375D, 0.25D, 0.375D, 0.625D, 0.375D, 0.625D));
                break;
            case 1:
                boxes.add(AxisAlignedBB.getBoundingBox(0.0D, 0.75D, 0.0D, 1.0D, 1.0D, 1.0D));
                boxes.add(AxisAlignedBB.getBoundingBox(0.375D, 0.625D, 0.375D, 0.625D, 0.75D, 0.625D));
                break;
            case 2:
                boxes.add(AxisAlignedBB.getBoundingBox(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 0.25D));
                boxes.add(AxisAlignedBB.getBoundingBox(0.375D, 0.375D, 0.25D, 0.625D, 0.625D, 0.375D));
                break;
            case 3:
                boxes.add(AxisAlignedBB.getBoundingBox(0.0D, 0.0D, 0.75D, 1.0D, 1.0D, 1.0D));
                boxes.add(AxisAlignedBB.getBoundingBox(0.375D, 0.375D, 0.625D, 0.625D, 0.625D, 0.75D));
                break;
            case 4:
                boxes.add(AxisAlignedBB.getBoundingBox(0.0D, 0.0D, 0.0D, 0.25D, 1.0D, 1.0D));
                boxes.add(AxisAlignedBB.getBoundingBox(0.25D, 0.375D, 0.375D, 0.375D, 0.625D, 0.625D));
                break;
            case 5:
                boxes.add(AxisAlignedBB.getBoundingBox(0.75F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F));
                boxes.add(AxisAlignedBB.getBoundingBox(0.625D, 0.375D, 0.375D, 0.75D, 0.625D, 0.625D));
                break;
            default:
                return null;
        }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack stack) {
        ...
        if (tile != null && tile instanceof TilePartblock) {
            ...
            if (stack.stackTagCompound != null) {
                ((TilePartblock) tile).getTile(partPos)
