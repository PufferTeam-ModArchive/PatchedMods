...
public class TileGear extends PTile implements ISpecialRenderTile {
    ...
    public AxisAlignedBB getRenderBoundingBox() {
        return AxisAlignedBB.getBoundingBox(-5.0D, -5.0D, -5.0D, 6.0D, 6.0D, 6.0D)
            .getOffsetBoundingBox(tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord);
    }
    ...
    // case 1: case 0: box = AxisAlignedBB.getBoundingBox(-gearSize, 0.0D, -gearSize, gearSize + 1, 1.0D, gearSize + 1);
    // break;
    // case 2: case 3: box = AxisAlignedBB.getBoundingBox(-gearSize, -gearSize, 0.0D, gearSize + 1, gearSize + 1, 1.0D);
    // break;
    // case 4: case 5: box = AxisAlignedBB.getBoundingBox(0.0D, -gearSize, -gearSize, 1.0D, gearSize + 1, gearSize + 1);
    // break;
    // }
