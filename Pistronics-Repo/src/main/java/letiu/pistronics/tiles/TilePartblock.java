...
public class TilePartblock extends PTile implements ITransmitter {
    ...
    public void update() {
        ...
        if (pulseTicks > 0) {
            ...
            if (pulseTicks == 0) {
                WorldUtil
                    .updateBlock(tileEntity.getWorldObj(), tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord);
            }
        }
        ...
        if (checkInput) {
            WorldUtil.notifyBlockOfNeighborChange(
                ...
                if (parts[i] != null) {
                    if (!((IPart) parts[i]).canPartStay(
                        ...
                        PacketHandler.sendToAllInDimension(
                            new SawPacket(tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord, i, dimID),
                            dimID);
                    }
                }
            }
