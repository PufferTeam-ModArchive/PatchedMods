...
public class BIRod extends PItemBlock implements IPartCompound {
    ...
    @Override
    public boolean canBlockTrigger(World world, int x, int y, int z, int side, EntityPlayer player, ItemStack stack) {

        // PBlock block = WorldUtil.getPBlock(world, x + Facing.offsetsXForSide[side], y + Facing.offsetsYForSide[side],
    ...
    public boolean placeBlockAt(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (!player.isSneaking() && ConfigData.predictPlacement) {
            ...
            PTile clickedTile = WorldUtil.getPTile(
                world,
