...
public class BlockData {
    ...
    public static PBlock piston, rotator, creativeMachine, rodFolder, rod, extension, camouBlock, partBlock, rodPart,
        extensionPart, motionblock, slimeBlock, gear, gearPart, sailPart, statue, stopper;
