...
public class GuiCreativeMachine extends GuiPContainer {
    ...
    protected static final ResourceLocation machineGui = new ResourceLocation(
        "pistronics",
        "textures/blocks/gui/empty.png");
    ...
    protected void actionPerformed(GuiButton guibutton) {
        ...
        switch (guibutton.id) {
            ...
            case 4:
                ...
                break;
            case 5:
                commandIndex = (commandIndex + 15) % 16;
                setButtonValues();
                break;
            case 6:
    ...
    public void initGui() {
        ...
        modeButton = new GuiCustomButton(
            2,
            x + xOffset,
            y + yOffset,
            20,
        ...
        rscLeftButton = new GuiCustomButton(
            5,
            x + xOffset,
            y + yOffset,
            10,
        ...
        rscRightButton = new GuiCustomButton(
            6,
            x + xOffset,
            y + yOffset,
            10,
        ...
        activateButton = new GuiCustomButton(
            7,
            x + xOffset,
            y + yOffset,
            20,
        ...
        /*
         * continousButton = new GuiCustomButton(4, x + xOffset, y + yOffset, 20, 20, "r", new Vector2(40, 0), new
         * Vector2(60, 0));
    ...
    protected void drawGuiContainerForegroundLayer(int param1, int param2) {
        ...
        getFontRenderer()
            .drawString(((commandIndex == 0) ? "*" : "" + commandIndex), 128 + ((commandIndex > 9) ? -3 : 0), 26, 0);
