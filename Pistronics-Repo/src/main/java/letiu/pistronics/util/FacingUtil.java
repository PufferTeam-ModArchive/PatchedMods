...
public class FacingUtil {
    ...
    // private static final int[][] sideToData =
    // {{0,1,2,3,4,5},{1,0,3,2,5,4},{2,3,4,5,0,1},{3,2,5,4,1,0},{4,5,0,1,2,3},{5,4,1,0,3,2}};
    private static final int[][] sideToData = { { 0, 1, 2, 3, 4, 5 }, { 1, 0, 3, 2, 5, 4 }, { 2, 3, 0, 1, 4, 5 },
        { 3, 2, 1, 0, 5, 4 }, { 4, 5, 2, 3, 0, 1 }, { 5, 4, 3, 2, 1, 0 } };
    private static final int[][] leftCrossData = { { -1, -1, 4, 5, 3, 2 }, { -1, -1, 4, 5, 3, 2 },
        { 5, 4, -1, -1, 0, 1 }, { 5, 4, -1, -1, 0, 1 }, { 3, 2, 0, 1, -1, -1 }, { 3, 2, 0, 1, -1, -1 } };

    public static int[][] rotateData = { { 0, 1, 4, 5, 3, 2 }, { 0, 1, 5, 4, 2, 3 }, { 5, 4, 2, 3, 0, 1 },
        { 4, 5, 2, 3, 1, 0 }, { 2, 3, 1, 0, 4, 5 }, { 3, 2, 0, 1, 4, 5 } };
    ...
    public static int getFacingFromClick(int facing, float xHit, float yHit, float zHit) {
        ...
        switch (facing) {
            case 0:
            case 1:
                return yHit > 0.5F ? 1 : 0;
            case 2:
            case 3:
                return zHit > 0.5F ? 3 : 2;
            case 4:
            case 5:
                return xHit > 0.5F ? 5 : 4;
        }
        return 0;
    }
