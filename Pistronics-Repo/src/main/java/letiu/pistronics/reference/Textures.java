...
public class Textures {
    ...
    // FULL PATHS //
    public static final ResourceLocation camouOverlay = new ResourceLocation(
        "pistronics",
        "textures/blocks/statue/camouOverlay.png");
    ...
    public static final ResourceLocation OAK_WOOD_PLANKS_RL = new ResourceLocation(
        "pistronics",
        Textures.OAK_WOOD_PLANKS);
    public static final ResourceLocation SPRUCE_WOOD_PLANKS_RL = new ResourceLocation(
        "pistronics",
        Textures.SPRUCE_WOOD_PLANKS);
    public static final ResourceLocation BIRCH_WOOD_PLANKS_RL = new ResourceLocation(
        "pistronics",
        Textures.BIRCH_WOOD_PLANKS);
    public static final ResourceLocation JUNGLE_WOOD_PLANKS_RL = new ResourceLocation(
        "pistronics",
        Textures.JUNGLE_WOOD_PLANKS);

    public static ResourceLocation getPlankTextureFromMeta(int meta) {
        switch (meta) {
            case 0:
                return OAK_WOOD_PLANKS_RL;
            case 1:
                return SPRUCE_WOOD_PLANKS_RL;
            case 2:
                return BIRCH_WOOD_PLANKS_RL;
            case 3:
                return JUNGLE_WOOD_PLANKS_RL;
            default:
                return OAK_WOOD_PLANKS_RL;
        }
    }
