...
public class StatueRenderer extends PTileRenderer {
    ...
    public static final MyTextureManager myTexManager = new MyTextureManager(
    ...
    public void renderStatueAt(RenderBlocks renderer, RenderBlocks fakeRenderer, TileStatue tile, double playerX,
        double playerY, double playerZ, float ticktime) {
        if (tile == null) return;
