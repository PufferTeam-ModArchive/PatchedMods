...
public class ElementRenderer extends PTileRenderer {
    ...
    @Override
    public void renderTileEntityAt(RenderBlocks renderer, RenderBlocks fakeRenderer, TileEntity tile, double playerX,
        double playerY, double playerZ, float ticktime) {
        renderElementAt(
            renderer,
            fakeRenderer,
            (TileElementHolder) (((BaseTile) tile).data),
            playerX,
            playerY,
            playerZ,
            ticktime);
    ...
    public void renderElementAt(RenderBlocks renderer, RenderBlocks fakeRenderer, TileElementHolder tile,
        ...
        switch (dir) {
            case 0:
                GL11.glRotatef(currentAngle, 0F, 1F, 0F);
                break;
            case 1:
                GL11.glRotatef(currentAngle, 0F, -1F, 0F);
                break;
            case 2:
                GL11.glRotatef(currentAngle, 0F, 0F, 1F);
                break;
            case 3:
                GL11.glRotatef(currentAngle, 0F, 0F, -1F);
                break;
            case 4:
                GL11.glRotatef(currentAngle, 1F, 0F, 0F);
                break;
            case 5:
                GL11.glRotatef(currentAngle, -1F, 0F, 0F);
                break;
    ...
    protected int getRotateDir(TileElementHolder tile) {
        return WorldUtil.getBlockFacing(
            tile.tileEntity.getWorldObj(),
            tile.tileEntity.xCoord,
            tile.tileEntity.yCoord,
            tile.tileEntity.zCoord);
    }
