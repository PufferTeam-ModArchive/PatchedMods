...
public class GearRenderer extends PTileRenderer {
    ...
    public void renderGearAt(RenderBlocks renderer, RenderBlocks fakeRenderer, TileGear tile, double playerX,
        double playerY, double playerZ, float ticktime) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (gear != null) {
                ...
                Minecraft.getMinecraft()
                    .getTextureManager()
                    .bindTexture(Textures.getPlankTextureFromMeta(gear.meta));
