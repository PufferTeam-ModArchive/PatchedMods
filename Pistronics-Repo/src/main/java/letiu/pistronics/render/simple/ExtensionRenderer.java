...
public class ExtensionRenderer extends PSimpleRenderer {
    ...
    public static boolean renderExtension(IBlockAccess world, int x, int y, int z, Block block, int facing,
        RenderBlocks renderer) {
    ...
    public static boolean renderExtension16(IBlockAccess world, int x, int y, int z, Block block, int facing,
        RenderBlocks renderer) {
