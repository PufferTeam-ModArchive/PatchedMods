...
public class PartRenderer extends PSimpleRenderer {
    ...
    public static boolean renderKnot(IBlockAccess world, int x, int y, int z, Block block, int facing,
                ...
                if (part != null) {
                    if (part instanceof BRodPart) {
                        ...
                        if (ModBaseInfo.MC_VERSION == "1.6.4") {
                            ExtensionRenderer
                                .renderExtension16(world, x, y, z, BlockData.extensionPart.block, i, renderer);
                        } else {
                            ExtensionRenderer
                                .renderExtension(world, x, y, z, BlockData.extensionPart.block, i, renderer);
                        }
