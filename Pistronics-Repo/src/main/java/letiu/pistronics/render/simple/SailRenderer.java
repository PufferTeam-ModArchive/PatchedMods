...
public class SailRenderer extends PSimpleRenderer {
    ...
    public static boolean renderSail(IBlockAccess world, int x, int y, int z, Block block, int position, int face,
        RenderBlocks renderer) {

        if (face == 0 || face == 1) {
            if (position == 2 || position == 3)
                renderer.setRenderBounds(0.0F, BSailPart.SAIL_A, 0.0F, 1.0F, BSailPart.SAIL_B, 0.75F);
            else if (position == 4 || position == 5)
                renderer.setRenderBounds(0.0F, BSailPart.SAIL_A, 0.0F, 0.75F, BSailPart.SAIL_B, 1.0F);
        } else if (face == 2 || face == 3) {
            if (position == 0 || position == 1)
                renderer.setRenderBounds(0.0F, 0.0F, BSailPart.SAIL_A, 1.0F, 0.75F, BSailPart.SAIL_B);
            else if (position == 4 || position == 5)
                renderer.setRenderBounds(0.0F, 0.0F, BSailPart.SAIL_A, 0.75F, 1.0F, BSailPart.SAIL_B);
        } else if (face == 4 || face == 5) {
            if (position == 0 || position == 1)
                renderer.setRenderBounds(BSailPart.SAIL_A, 0.0F, 0.0F, BSailPart.SAIL_B, 0.75F, 1.0F);
            else if (position == 2 || position == 3)
                renderer.setRenderBounds(BSailPart.SAIL_A, 0.0F, 0.0F, BSailPart.SAIL_B, 1.0F, 0.75F);
        }

        switch (position) {
            case 0:
                Tessellator.instance.addTranslation(0F, -0.375F, 0F);
                break;
            case 1:
                Tessellator.instance.addTranslation(0F, 0.625F, 0F);
                break;
            case 2:
                Tessellator.instance.addTranslation(0F, 0F, -0.375F);
                break;
            case 3:
                Tessellator.instance.addTranslation(0F, 0F, 0.625F);
                break;
            case 4:
                Tessellator.instance.addTranslation(-0.375F, 0F, 0F);
                break;
            case 5:
                Tessellator.instance.addTranslation(0.625F, 0F, 0F);
                break;
        }
