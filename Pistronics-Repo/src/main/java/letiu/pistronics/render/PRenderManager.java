...
public class PRenderManager {
    ...
    public static PSimpleRenderer pistonRenderer, rodRenderer, extensionRenderer, partRenderer, slimeblockRenderer,
        sailRenderer;
    public static PTileRenderer elementRenderer, motionRenderer, mechElementRenderer, gearRenderer, statueRenderer,
        rodFolderElementRenderer;
    public static PItemRenderer extensionItemRenderer, rodItemRenderer, sailItemRenderer, gearItemRenderer,
        statueItemRenderer;
