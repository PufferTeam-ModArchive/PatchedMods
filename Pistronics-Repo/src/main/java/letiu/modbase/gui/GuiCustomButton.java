...
public class GuiCustomButton extends GuiButton {
    ...
    protected static final ResourceLocation buttonIcon = new ResourceLocation(
        "pistronics",
     ...
     * this.drawTexturedModalRect(this.xPosition, this.yPosition, 0, 46 + k * 20, this.width / 2, this.height);
     * this.drawTexturedModalRect(this.xPosition + this.width / 2, this.yPosition, 200 - this.width / 2, 46 + k * 20,
