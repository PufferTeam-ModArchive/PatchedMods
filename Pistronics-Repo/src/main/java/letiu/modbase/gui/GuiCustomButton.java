...
public class GuiCustomButton extends GuiButton {
	...
	public void drawButton(Minecraft minecraft, int x, int y) {
		if (this.visible) {
			...
			if (this.inverted) {
				this.drawTexturedModalRect(this.xPosition, this.yPosition, this.uv2.x, this.uv2.y, this.width, this.height);
			} else {
				this.drawTexturedModalRect(this.xPosition, this.yPosition, this.uv1.x, this.uv1.y, this.width, this.height);
			}
