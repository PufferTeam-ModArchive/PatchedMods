...
public class FakeWorld extends World {
    ...
    public void addFakeTl(TileEntity tile, Vector3 coords) {
        if (tile != null) {
            ...
            // System.out.println("CacheTL coords: " + tileEntities.get(0).xCoord + "/" + tileEntities.get(0).yCoord +
            // "/" + tileEntities.get(0).zCoord + "/");
        }
    }
    ...
    @Override
    public boolean canPlaceEntityOnSide(Block par1, int par2, int par3, int par4, boolean par5, int par6,
    ...
    public Entity findNearestEntityWithinAABB(Class par1Class, AxisAlignedBB par2AxisAlignedBB, Entity par3Entity) {
        // TODO Auto-generated method stub
        return realWorld.findNearestEntityWithinAABB(par1Class, par2AxisAlignedBB, par3Entity);
    }
    ...
    public List getEntitiesWithinAABBExcludingEntity(Entity par1Entity, AxisAlignedBB par2AxisAlignedBB,
        ...
        // TODO Auto-generated method stub
        return realWorld.getEntitiesWithinAABBExcludingEntity(par1Entity, par2AxisAlignedBB, par3iEntitySelector);
    }
    ...
    public PathEntity getEntityPathToXYZ(Entity par1Entity, int par2, int par3, int par4, float par5, boolean par6,
        ...
        // TODO Auto-generated method stub
        return realWorld.getEntityPathToXYZ(par1Entity, par2, par3, par4, par5, par6, par7, par8, par9);
    }
    ...
    public PathEntity getPathEntityToEntity(Entity par1Entity, Entity par2Entity, float par3, boolean par4,
        ...
        // TODO Auto-generated method stub
        return realWorld.getPathEntityToEntity(par1Entity, par2Entity, par3, par4, par5, par6, par7);
    }
    ...
    public boolean handleMaterialAcceleration(AxisAlignedBB par1AxisAlignedBB, Material par2Material,
        Entity par3Entity) {
        // TODO Auto-generated method stub
        return realWorld.handleMaterialAcceleration(par1AxisAlignedBB, par2Material, par3Entity);
    }
    ...
    @Override
    public void notifyBlockOfNeighborChange(int par1, int par2, int par3, Block par4) {
        // TODO Auto-generated method stub
        realWorld.notifyBlockOfNeighborChange(par1, par2, par3, par4);
    }

    @Override
    public void notifyBlocksOfNeighborChange(int par1, int par2, int par3, Block par4) {
        // TODO Auto-generated method stub
        realWorld.notifyBlocksOfNeighborChange(par1, par2, par3, par4);
    }

    @Override
    public void notifyBlocksOfNeighborChange(int par1, int par2, int par3, Block par4, int par5) {
        // TODO Auto-generated method stub
    ...
    public List selectEntitiesWithinAABB(Class par1Class, AxisAlignedBB par2AxisAlignedBB,
        IEntitySelector par3iEntitySelector) {
        // TODO Auto-generated method stub
        return realWorld.selectEntitiesWithinAABB(par1Class, par2AxisAlignedBB, par3iEntitySelector);
    }
    ...
    public void func_147446_b(int p_147446_1_, int p_147446_2_, int p_147446_3_, Block p_147446_4_, int p_147446_5_,
        int p_147446_6_) {
        // TODO Auto-generated method stub
        realWorld.func_147446_b(p_147446_1_, p_147446_2_, p_147446_3_, p_147446_4_, p_147446_5_, p_147446_6_);
    }
    ...
    public MovingObjectPosition func_147447_a(Vec3 p_147447_1_, Vec3 p_147447_2_, boolean p_147447_3_,
        ...
        // TODO Auto-generated method stub
        return realWorld.func_147447_a(p_147447_1_, p_147447_2_, p_147447_3_, p_147447_4_, p_147447_5_);
    }
    ...
    public boolean isBlockTickScheduledThisTick(int p_147477_1_, int p_147477_2_, int p_147477_3_, Block p_147477_4_) {
        // TODO Auto-generated method stub
        return realWorld.isBlockTickScheduledThisTick(p_147477_1_, p_147477_2_, p_147477_3_, p_147477_4_);
    }
    ...
    public void scheduleBlockUpdate(int p_147464_1_, int p_147464_2_, int p_147464_3_, Block p_147464_4_,
        int p_147464_5_) {
        // TODO Auto-generated method stub
        realWorld.scheduleBlockUpdate(p_147464_1_, p_147464_2_, p_147464_3_, p_147464_4_, p_147464_5_);
    }
    ...
    public void scheduleBlockUpdateWithPriority(int p_147454_1_, int p_147454_2_, int p_147454_3_, Block p_147454_4_,
        ...
        // TODO Auto-generated method stub
        realWorld.scheduleBlockUpdateWithPriority(
            p_147454_1_,
            p_147454_2_,
            p_147454_3_,
            p_147454_4_,
