        ...
        try {
            ...
            for (Object key : keys) {
                ...
                if (co.value instanceof Integer) {
                    co.value = configuration.get(TWEAKS, (String) key, (Integer) co.value, co.comment)
                        .getInt();
                } else if (co.value instanceof Boolean) {
                    co.value = configuration.get(TWEAKS, (String) key, (Boolean) co.value, co.comment)
                        .getBoolean((Boolean) co.value);
                } else if (co.value instanceof Double) {
                    co.value = configuration.get(TWEAKS, (String) key, (Double) co.value, co.comment)
                        .getDouble(6D);
                } else if (co.value instanceof String) {
                    co.value = configuration.get(TWEAKS, (String) key, (String) co.value, co.comment)
                        .getString();
                }
            }
