...
public class WorldUtil {
    ...
    public static int getBlockFacing(PTile tile) {
        return tile.tileEntity.getWorldObj()
            .getBlockMetadata(tile.tileEntity.xCoord, tile.tileEntity.yCoord, tile.tileEntity.zCoord) & 7;
    }
    ...
    public static void setBlockBounds(IBlockAccess world, int x, int y, int z, float minX, float minY, float minZ,
    ...
    public static void setBlockBounds(Block block, float minX, float minY, float minZ, float maxX, float maxY,
        float maxZ) {
    ...
    public static void setBlock(TileEntity tile, Block block) {
        tile.getWorldObj()
            .setBlock(tile.xCoord, tile.yCoord, tile.zCoord, block);
    }
    ...
    public static void setBlockToAir(TileEntity tile) {
        tile.getWorldObj()
            .setBlockToAir(tile.xCoord, tile.yCoord, tile.zCoord);
    }
            ...
            if (block instanceof BlockLever) {
                ...
                switch (side ^ 1) {
                    ...
                    case 2:
                        return meta == 4; // NORTH
                    case 1:
                        return meta == 5 || meta == 6; // UP
                    case 0:
                        return meta == 7 || meta == 0; // DOWN
                }
            }
