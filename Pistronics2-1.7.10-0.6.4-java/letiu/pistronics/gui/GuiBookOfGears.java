...
public class GuiBookOfGears extends GuiBase {
    ...
    protected static final ResourceLocation bookTexture = new ResourceLocation(
        "pistronics",
        "textures/blocks/gui/BookOfGears.png");
    protected static final ResourceLocation frameTexture = new ResourceLocation(
        "pistronics",
        "textures/blocks/gui/frame02.png");
    protected static final ResourceLocation arrowTexture = new ResourceLocation(
        "pistronics",
        "textures/blocks/gui/testIcon.png");
    protected static final ResourceLocation blockTextures = new ResourceLocation(
        "pistronics",
        "textures/blocks/gui/blockTextures.png");
    ...
    public void drawTexture(ResourceLocation texture, int x, int y, int u, int v, int width, int height, int dir,
        float scaling) {
        float antiScaling = 1 / scaling;
    ...
    public void drawStack(ItemStack stack, int meta, int x, int y, float scaling) {
        ...
        if (!ForgeHooksClient
            .renderInventoryItem(renderBlocks, this.mc.getTextureManager(), stack, true, 200, localX, localY)) {
