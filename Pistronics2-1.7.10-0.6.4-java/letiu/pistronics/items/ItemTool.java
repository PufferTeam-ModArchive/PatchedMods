...
public class ItemTool extends PItem {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean value) {
        ...
        list.add(
            EnumChatFormatting.BLUE + "Use this to "
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (block != null && block instanceof BStatue) {
            ...
            if (tile != null && tile instanceof TileStatue) {
                ...
                if (!world.isRemote) PacketHandler.sendToAllInDimension(
                    new StatueDataPacket(((TileStatue) tile), player.dimension),
                    player.dimension);
            }
            return true;
        }
        ...
        if (block != null && block instanceof PBlock) {
